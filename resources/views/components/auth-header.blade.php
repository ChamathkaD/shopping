                        ...
                        <ul>
                            ...
                            @else
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="{{ route('account') }}"><i class="fi-rs-user mr-10"></i> Account</a></li>
                                        <form action="{{ route('logout') }}" method="post">
                                            @csrf
                                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();this.closest('form').submit();"><i class="fi-rs-sign-out mr-10"></i>log out</a></li>
                                        </form>
