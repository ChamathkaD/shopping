                            ...
                            <div class="col-md-4">
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="change-password-tab" data-bs-toggle="tab" href="#change-password" role="tab" aria-controls="change-password" aria-selected="true"><i class="fi fi-rs-lock mr-10"></i>Change Password</a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p>Sarasota</p>
                                                        <a href="{{ route('profile.newAddress') }}" class="btn-small">Edit</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <form wire:submit.prevent="updateProfileInformation">
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input required="" class="form-control square" name="name" type="text" wire:model.defer="state.name">
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label>Birthday <span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="dob" type="date" wire:model.defer="state.dob">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>Email Address <span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="email" type="email" wire:model.defer="state.email">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>Phone<span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="phone" type="text" wire:model.defer="state.phone">
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label>Gender<span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="gender" type="text" wire:model.defer="state.gender">
                                                        </div>
                                                        <div class="col-md-12">
